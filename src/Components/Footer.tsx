      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g
          ...
          <g
            ...
            fill="#f0f8ff"
            data-darkreader-inline-fill=""
            className="group-hover:fill-purple-600 transition-colors duration-200">
            {" "}
  ...
  return (
    <footer className="relative bottom-0 text-center col-span-4 flex gap-12 items-center justify-center p-2">
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="flex items-center gap-2 group hover:text-purple-600 transition-colors duration-200">
        DarkTimes <span className="w-8">{GitHubSVG}</span>
      </a>
      <a
