...
const PlatformsContainer = ({ item }: ItemProp) => {
  const svgPaths: SvgPaths = {
    ios: (
      <svg
        viewBox="0 -64.5 257 257"
        version="1.1"
